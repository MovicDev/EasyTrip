...
Gender
	...
	<option>2</option></select><br><br>
	 ...
	 <h3>Passanger3</h3>
<input type="text" name="name_2"  placeholder="full name"><br><br>
	 Nationality
<select name="nation_2" ><option>A</option>
	<option>B</option>
	<option>C</option>
	<option>D</option>
	<option>E</option></select><br><br>
Gender
	 <select name="gender_2"><option>Male</option>
	<option>Female</option></select><br><br>
	 
	DOB
	<select name="year_2"><option>2002</option>
	<option>2020</option></select>
	 <select name="month_2"><option>h</option>
	<option>F</option></select>
	 <select name="day_2"><option>9</option>
	<option>2</option></select><br><br>
	 
	 <h3>Passanger4</h3>
<input type="text" name="name_3"  placeholder="full name"><br><br>
	 Nationality
<select name="nation_3" ><option>A</option>
	<option>B</option>
	<option>C</option>
	<option>D</option>
	<option>E</option></select><br><br>
Gender
	 <select name="gender_3"><option>Male</option>
	<option>Female</option></select><br><br>
	 
	DOB
	<select name="year_3"><option>2002</option>
	<option>2020</option></select>
	 <select name="month_3"><option>h</option>
	<option>F</option></select>
	 <select name="day_3"><option>9</option>
	<option>2</option></select><br><br>
