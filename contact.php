  ...
  <nav class="site-nav">
    <div class="container">
      <div class="site-navigation">
        <a href="index.html" class="logo m-0">EasyTrip <span class="text-primary">.</span></a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 mb-5 mb-lg-0">
          <form class="contact-form" data-aos="fade-up" data-aos-delay="200" action="mail.php" method="post">
            <div class="row">
              <div class="col-12">
            ...
            <div class="form-group">
              ...
              <textarea name="comment" class="form-control" id="message" cols="30" rows="5"></textarea>
            </div>
        ...
        <div class="col-lg-5 ml-auto">
          <div class="quick-contact-item d-flex align-items-center mb-4">
            ...
            <address class="text">
              Ajia Road 7,House 3, Adegbayi Ibadan.
            </address>
          </div>
          <div class="quick-contact-item d-flex align-items-center mb-4">
          ...
          <div class="col-md-6 col-lg-4">
            <div class="widget">
              ...
              <ul class="list-unstyled quick-info links">
                <li class="email"><a href="#">movicunique01@gmail.com</a></li>
